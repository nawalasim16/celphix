  ...
  return (
    <LiquidLayout>
      ...
      <div className="bg-white pt-20 pb-10 px-4 text-center border-b border-gray-100">
        <h1 className="text-5xl md:text-6xl font-black text-[#274e13] tracking-tight uppercase mb-4">Architecture & Services</h1>
        <p className="text-xl text-gray-600 font-sans max-w-2xl mx-auto">Technical capabilities mapping for scalable voice infrastructure.</p>
      </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="mb-16 border-b border-gray-200 pb-4">
            <h2 className="text-3xl font-black text-[#274e13] uppercase tracking-tight">The Liquid Core</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 border border-gray-200 hover:border-[#008613] transition-all bg-white relative group">
              ...
              <h3 className="text-xl font-bold text-[#274e13] mb-4">On-Demand Instance Summoning</h3>
            ...
            <div className="p-8 border border-gray-200 hover:border-[#008613] transition-all bg-white relative group">
              ...
              <h3 className="text-xl font-bold text-[#274e13] mb-4">Neural Context Injection</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="p-8 border border-gray-200 hover:border-[#008613] transition-all bg-white relative group">
              ...
              <h3 className="text-xl font-bold text-[#274e13] mb-4">Event-Driven Automation</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
      ...
      <section className="py-24 px-4 bg-gray-50 border-y border-gray-200">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16 border-b border-gray-200 pb-4">
            <h2 className="text-3xl font-black text-[#274e13] uppercase tracking-tight">Execution Library</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-8 bg-white border border-gray-200 shadow-sm flex gap-6 items-start hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#274e13] mb-2">Rapid Outbound Pulse</h3>
            ...
            <div className="p-8 bg-white border border-gray-200 shadow-sm flex gap-6 items-start hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#274e13] mb-2">Interactive Intelligent IVR</h3>
            ...
            <div className="p-8 bg-white border border-gray-200 shadow-sm flex gap-6 items-start hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#274e13] mb-2">Seasonal Support Scaling</h3>
            ...
            <div className="p-8 bg-white border border-gray-200 shadow-sm flex gap-6 items-start hover:shadow-md transition-shadow">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#274e13] mb-2">Data Discovery & Polling</h3>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="bg-white border border-gray-200 font-sans text-sm shadow-sm">
      ...
      <section className="py-24 px-4 bg-gray-50 text-center border-t border-gray-200">
        <div className="container mx-auto max-w-3xl">
          ...
          <p className="text-lg text-gray-600 font-sans mb-10">
