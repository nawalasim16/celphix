...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: 'Login functionality is not yet available. Please check back soon!',
      });
  ...
  return (
    <>
      <Helmet>
        <title>Login - Celphix | Elite Autonomous Voice Communication</title>
        <meta name="description" content="Login to your Celphix account and access the future of autonomous voice communication." />
      </Helmet>
